        ...
        <div class="section-card">
            ...
            <div class="table-wrap">
                <table class="admin-table" id="cmdTable">
                    <thead><tr><th>#</th><th>Client</th><th>Date</th><th>Total</th><th>Statut commande</th><th>Livreur</th><th>Actions</th></tr></thead>
                    <tbody id="cmdTbody">
                    ...
                    ?>
                        <tr data-statut="<?= htmlspecialchars(mb_strtolower($cmd['STATUT_COMMANDE'] ?? '')) ?>">
                            ...
                            <td><strong><?= number_format((float)$cmd['TOTAL'], 2, ',', ' ') ?> DH</strong></td>
