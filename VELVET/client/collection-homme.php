...
<head>
    ...
    <title>Collection Hommes — Velvet</title>
...
<section class="collection-wrap">
    <div class="container">
        ...
        <div class="empty-coll">
            ...
            <a href="collection-homme.php" style="display:inline-block;margin-top:16px;background:#000;color:#fff;padding:10px 24px;border-radius:8px;font-size:11px;letter-spacing:2px;text-transform:uppercase;text-decoration:none;">Voir tout</a>
        </div>
        <?php else: ?>
            ...
            <div class="col-6 col-md-4 col-lg-3 prod-col" style="animation-delay: <?= $i * 0.045 ?>s;">
                <div class="prod-card">
                    ...
                    <div class="prod-img-wrap">
                        ...
                        <button class="btn-wish" title="Favoris" onclick="toggleWish(this)">
