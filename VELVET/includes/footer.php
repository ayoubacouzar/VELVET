    ...
    <div class="container-xl px-4">
        <div class="row g-5">
            ...
            <div class="col-12 col-lg-4">
                ...
                <p style="font-size:11px;color:rgba(249,247,242,0.4);margin-bottom:20px;letter-spacing:0.5px;text-align:left;">
            ...
            <div class="col-6 col-sm-3 col-lg-2">
                ...
                <ul class="footer-links">
                    ...
                    <li>
                        <a href="<?= $base ?>client/produits.php?categorie=<?= $fc['ID_CATEGORIE'] ?>">
                            Mode <?= htmlspecialchars(ucfirst(strtolower($fc['NOM_CATEGORIE']))) ?>
                        </a>
                    </li>
                    <?php endforeach; ?>
                    <li>
                        <a href="<?= $base ?>client/produits.php">Tous les produits</a>
                    </li>
                    <li>
                        <a href="<?= $base ?>client/produits.php?filter=promo">Promotions</a>
                    </li>
                </ul>
            </div>
